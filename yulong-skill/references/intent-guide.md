...
| 用户、角色、组织、权限、通讯录、部门管理 | [`yulong-rbac`](../yulong-rbac/SKILL.md) | `yulong rbac user userPage`、`yulong hr dept getDeptTree`、`yulong hr employee addressBook`、`yulong hr dept list/detail/add/edit/del` |
